...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">创建职位</li>
    </ol>
@stop

@section('content')
    <h2 class="page-header">创建职位</h2>
    <div class="box box-primary">
        <form method="POST" action="/admin/positions" accept-charset="utf-8">
            {!! csrf_field() !!}
                    ...
                    <div class="tab-pane active">
                        ...
                        <div class="form-group">
                            ...
                            <input required="required" type="text" class="form-control" name="work_area" autocomplete="off"
                                   placeholder="work_area" maxlength="80">
                        </div>
